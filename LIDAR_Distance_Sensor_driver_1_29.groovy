...
metadata {
    definition (name: "Zigbee Lidar Distance Sensor", namespace: "John Land v. 1.29", author: "John Land") {
        ...
        attribute "Distance Summary", "string"
        ...
        fingerprint profileId: "0104", inClusters: "0000,0003,0400,0006", outClusters: "", manufacturer: "Arduino",   deviceJoinName: "Zigbee Lidar Distance Sensor"
        fingerprint profileId: "0104", inClusters: "0000,0003,0400,0006", outClusters: "", manufacturer: "M5Stack",   deviceJoinName: "Zigbee Lidar Distance Sensor"
    }
...
def configure() {
    ...
    cmds += zigbee.configureReporting(0x0400, 0x0000, 0x21,
        (minReportInterval ?: 10).toInteger(),
        (maxReportInterval ?: 300).toInteger(),
        (reportDelta ?: 50).toInteger(),
        [destEndpoint: 10])
...
def parse(String description) {
    ...
    def ep = descMap?.endpoint ? Integer.parseInt(descMap.endpoint, 16) : 10
...
def processDistance(distanceMillimeters) {
    ...
    sendEventIfChanged("Distance Summary", buildDistanceSummary(values), null, false)
